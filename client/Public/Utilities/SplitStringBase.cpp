/*$T Share/Utilities/SplitStringBase.cpp GC 1.140 10/10/07 10:06:57 */
...
BOOL SplitStringBase::DoSubSplit()
{
	...
	{
		for(int32 _Idx = 0; _Idx < m_iLevelOneLineCount; ++_Idx)
		{
			m_pChild->DoSplit(m_strSplitLevelOne[_Idx]);
		}
	}
