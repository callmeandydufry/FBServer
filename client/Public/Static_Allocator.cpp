/*$T Share/Static_Allocator.cpp GC 1.140 10/10/07 10:06:54 */
...
void *Static_Allocator::Malloc(size_t nSize)
{
	...
	{
		QLogSystem::QUICK_LOG(SLOW_LOG_SERVERERROR, "Malloc(): Out of memory allocating %d bytes.\n", nSize);
		KCheck(FALSE);
...
void *Static_Allocator::Realloc(void *pData, size_t nNewSize)
{
	...
	if(this->m_Offset + nSize > this->m_Size)
	{
		QLogSystem::QUICK_LOG(SLOW_LOG_SERVERERROR, "Realloc(): Out of memory allocating %d bytes.\n", nSize);
		KCheck(FALSE);
