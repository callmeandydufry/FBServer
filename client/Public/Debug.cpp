/*$T Share/Debug.cpp GC 1.140 10/10/07 10:06:26 */
...
void _KMessage(const char *szTemp)
{
	...
	// 临时去掉弹框，避免阻塞服务器逻辑 [yangzhen]
	{
		...
		if(KCheckState() != 1)
		{
			...
			/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
			int32	iRet = ::MessageBoxA(NULL, szTemp, "异常", MB_OK);
			/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
		}
	}
#endif
...
#if defined(__WINDOWS__)
	// 临时去掉弹框，这样可以避免阻塞服务器 [yangzhen]
	::MessageBoxA(NULL, msg, "状态信息", MB_OK);
#elif defined(__LINUX__)
#endif
}
